...
class EmailClass{
        ...
        function sendTheForgotPasswordEmail($ReceiverEmail, $forgotPassword){
            $name = "Escape The Villange";  // Name of your website or yours
            $to = $ReceiverEmail;  // mail of reciever
            ...
            <div style="margin:50px auto;width:70%;padding:20px 0">
              <div style="border-bottom:1px solid #eee">
                <a href="#" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600;">Escape The Village: Forgot Password</a>
              </div>
              <p style="font-size:1.1em">Dear Player,</p>
              <p>Here is your account password!!!</p>
              
              <h2 style="background: #00466a;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">Password: '.$forgotPassword.'</h2>
              
              <p><span style="color:red;">WARNING: </span>Please make sure to change your password once you login in successfully!!!.</p>
